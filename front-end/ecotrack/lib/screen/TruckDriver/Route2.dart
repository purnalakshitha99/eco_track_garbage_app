...
class _Route2State extends State<Route2> {
  ...
  Set<Circle> circles = {}; // Define circles set
  ...
  Future<void> _loadUserLocations() async {
    try {
      String data = await rootBundle.loadString('asset/user_locations.json');
    ...
    return Scaffold(
      ...
      body: GoogleMap(
        ...
        initialCameraPosition: CameraPosition(
          target: LatLng(6.9061, 79.9696),
          zoom: 15,
        ),
        circles: circles, // Add circles to the GoogleMap
